...
class Cage:
    def __init__(self, count_cell):
        # self._count_cell = None  # вот здесь я не совсем поняла, нужно ли мне эту строку писать вообще -
        # по идее сделующей строкой защищенный атрибут _count_cell создастся в обязательном порядке
        # работает и с ней и без нее
...
if __name__ == '__main__':
    ...
    # # если кто-то напрямую изменит защищенный атрибут на недопустимое значение,
    # # а мы далее вызовем через геттер его значение - увидим наше исключение
    # cage_3._count_cell = '45f'
    # print(cage_3.count_cell)
